%% script_test_fcn_Transform_LiDARVelodyneToENU
...
fig_num = 124;
fid = 1;
M_transform_LiDARVelodyne_to_ENU = fcn_Transform_CalculateTransformation_LiDARVelodyneToENU(GPSFront_ENU, GPSLeft_ENU, GPSRight_ENU,[],fid, fig_num);