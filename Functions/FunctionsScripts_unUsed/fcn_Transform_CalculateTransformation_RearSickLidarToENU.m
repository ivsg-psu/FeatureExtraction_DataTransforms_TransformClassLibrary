function Mtransform_LidarSickRear_to_ENU = fcn_Transform_CalculateTransformation_RearSickLidarToENU(GPSLeft_ENU, GPSRight_ENU, GPSFront_ENU,calibrate_matrix)
...
% Create the transformation matrix from Sick LiDAR to Rear GPS Center
...
Mtransform_LidarSickRear_to_ENU = Mtransform_RearGPSCenter_to_ENU*Mtransform_LidarSickRear_to_RearGPSCenter;
