function transformed_GPSSparkFunRightRearCoord_in_ENU = fcn_Transform_GPSSparkFunRightRearCoordToENU(vehicleParameters, sensorPoseParameters, sensor_or_vehicle, vehiclePose_ENU, sensorReading_SensorCoord, varargin)
...
transform_Matrix = fcn_Transform_determineTransformMatrix_GPS_SparkFun_RightRear(vehicleParameters, sensorPoseParameters, sensor_or_vehicle, vehiclePose_ENU, ...
...
transformed_GPSSparkFunRightRearCoord_in_ENU = zeros(size(vehiclePose_ENU,1),3);
...
for i = 1:size(vehiclePose_ENU,1)
    ...
    transformed_GPSSparkFunRightRearCoord_in_ENU(i,:) = transformed_SensorCoordPoint_in_ENU_homogeneous(1:3,:)';  
end

disp(transformed_GPSSparkFunRightRearCoord_in_ENU);
...
if flag_do_plots
    ...
    plot3(transformed_GPSSparkFunRightRearCoord_in_ENU(1),transformed_GPSSparkFunRightRearCoord_in_ENU(2),transformed_GPSSparkFunRightRearCoord_in_ENU(3),'r.','MarkerSize',50);
