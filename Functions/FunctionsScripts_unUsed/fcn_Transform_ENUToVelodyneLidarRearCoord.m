function transformed_ENUPoint_in_VelodyneLidarRearCoord = fcn_Transform_ENUToVelodyneLidarRearCoord(vehicleParameters, sensorPoseParameters, sensor_or_vehicle, vehiclePose_ENU, sensorReading_ENU, varargin)
...
transformed_ENUPoint_in_VelodyneLidarRearCoord = zeros(size(vehiclePose_ENU,1),3);
...
for i = 1:size(vehiclePose_ENU,1)
    ...
    transformed_ENUPoint_in_VelodyneLidarRearCoord(i,:) = transformed_ENUPoint_in_SensorCoord_homogeneous(1:3,:)';
end
