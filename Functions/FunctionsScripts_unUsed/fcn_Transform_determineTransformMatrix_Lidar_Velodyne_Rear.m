function transform_Matrix = fcn_Transform_determineTransformMatrix_Lidar_Velodyne_Rear(vehicleParameters, sensorPoseParameters, sensor_or_vehicle, vehiclePose_ENU, perturbation_in_sensorPose_relative_to_SensorPlatform, varargin)
