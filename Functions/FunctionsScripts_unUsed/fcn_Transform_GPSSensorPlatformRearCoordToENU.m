function transformed_GPSSensorPlatformRearCoord_in_ENU = fcn_Transform_GPSSensorPlatformRearCoordToENU(vehicleParameters, sensorPoseParameters, sensor_or_vehicle, vehiclePose_ENU, sensorReading_SensorCoord, varargin)
...
transform_Matrix = fcn_Transform_determineTransformMatrix_GPS_SensorPlatform_Rear(vehicleParameters, sensorPoseParameters, sensor_or_vehicle, vehiclePose_ENU, ...
                                                             perturbation_in_sensorPose_relative_to_SensorPlatform, fig_num);

%% Find the transformed_SensorCoordPoint_in_ENU_homogeneous
...
transformed_GPSSensorPlatformRearCoord_in_ENU = zeros(size(vehiclePose_ENU,1),3);
...
for i = 1:size(vehiclePose_ENU,1)
    ...
    transformed_GPSSensorPlatformRearCoord_in_ENU(i,:) = transformed_SensorCoordPoint_in_ENU_homogeneous(1:3,:)';  
end

disp(transformed_GPSSensorPlatformRearCoord_in_ENU);
...
if flag_do_plots
    ...
    plot3(transformed_GPSSensorPlatformRearCoord_in_ENU(1),transformed_GPSSensorPlatformRearCoord_in_ENU(2),transformed_GPSSensorPlatformRearCoord_in_ENU(3),'r.','MarkerSize',50);
