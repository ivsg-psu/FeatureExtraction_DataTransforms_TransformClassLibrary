% script_test_fcn_Transform_SensorCoordToENU_GPSSparkFunRightRear.m
...
% A point in right GPS coordinates.  
sensorReading_SensorCoord = [0.6027 4.7295 -1.6382];
...
% A point in right GPS coordinates.  
sensorReading_SensorCoord = [8.6027 -0.2705 4.3618];
...
% A point in right GPS coordinates.  
sensorReading_SensorCoord = [9.6027 5.7295 -2.6382];
...
% A point in right GPS coordinates.  
sensorReading_SensorCoord = [-3.3973 -6.2705 -2.6382];
...
% A point in right GPS coordinates.  
sensorReading_SensorCoord = [9.6027 -2.2705 -8.6382];
...
% A point in right GPS coordinates.  
sensorReading_SensorCoord = [3.6027 -2.2705 -5.6382];
...
% A point in right GPS coordinates. 
sensorReading_SensorCoord = [6.6027 -3.2705 7.3618];
...
% A point in right GPS coordinates. 
sensorReading_SensorCoord = [7.6027 4.7295 -2.6382];
...
% A point in right GPS coordinates. 
sensorReading_SensorCoord = [-7.3973 13.7295 1.3618];
...
% A point in right GPS coordinates. 
sensorReading_SensorCoord = [6.6027 2.7295 5.3618];
...
% A point in right GPS coordinates. 
sensorReading_SensorCoord = [19.6027 -5.2705 8.3618];
...
% A point in right GPS coordinates. 
sensorReading_SensorCoord = [-11.3973 -4.2705 -11.6382];
...
% A point in right GPS coordinates. 
sensorReading_SensorCoord = [15.6027 -1.2705 -5.6382];
...
% A point in right GPS coordinates. 
sensorReading_SensorCoord = [7.6027 -4.2705 3.3618];
