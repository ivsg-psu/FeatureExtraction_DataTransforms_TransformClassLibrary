function transformed_VelodyneLidarRearCoord_in_ENU = fcn_Transform_VelodyneLidarRearCoordToENU(vehicleParameters, sensorPoseParameters, sensor_or_vehicle, vehiclePose_ENU, sensorReading_SensorCoord, varargin)
...
transform_Matrix = fcn_Transform_determineTransformMatrix_Lidar_Velodyne_Rear(vehicleParameters, sensorPoseParameters, sensor_or_vehicle, vehiclePose_ENU, ...
...
transformed_VelodyneLidarRearCoord_in_ENU = zeros(size(vehiclePose_ENU,1),3);
...
for i = 1:size(vehiclePose_ENU,1)
    ...
    transformed_VelodyneLidarRearCoord_in_ENU(i,:) = transformed_SensorCoordPoint_in_ENU_homogeneous(1:3,:)';  
end

disp(transformed_VelodyneLidarRearCoord_in_ENU);
...
if flag_do_plots
    ...
    plot3(transformed_VelodyneLidarRearCoord_in_ENU(1),transformed_VelodyneLidarRearCoord_in_ENU(2),transformed_VelodyneLidarRearCoord_in_ENU(3),'r.','MarkerSize',50);
