% script_test_fcn_Transform_ENUToSensorCoord_GPSSparkFunLeftRear.m
...
% sensorReading_ENU in left GPS coordinates will be [-4.3973 -0.7295 -1.6382]
...
%
% Therefore, the expected answer of the transformed
% sensorReading_ENU in left GPS coordinates will be [0.6027  3.2705 -1.6382]
...
transformed_ENUPoint_in_dashCoord = fcn_Transform_ENUToSensorCoord(vehicleParameters, sensorPoseParameters, in_dashCoord, vehiclePose_ENU, sensorReading_ENU, perturbation_in_sensorPose, fig_num);
expected_transformed_ENUPoint_in_dashCoord = [0.6027  3.2705 -1.6382];
...
%
% Therefore, the expected answer of the transformed
% sensorReading_ENU in left GPS coordinates will be [0.6027 -0.7295 -3.6382]
...
%
% Therefore, the expected answer of the transformed
% sensorReading_ENU in left GPS coordinates will be [8.6027 -1.7295 4.3618]
...
transformed_ENUPoint_in_dashCoord = fcn_Transform_ENUToSensorCoord(vehicleParameters, sensorPoseParameters, in_dashCoord, vehiclePose_ENU, sensorReading_ENU, perturbation_in_sensorPose, fig_num);
expected_transformed_ENUPoint_in_dashCoord = [8.6027 -1.7295 4.3618];
...
%
% Therefore, the expected answer of the transformed
% sensorReading_ENU in left GPS coordinates will be [9.6027 4.2705 -2.6382]
...
transformed_ENUPoint_in_dashCoord = fcn_Transform_ENUToSensorCoord(vehicleParameters, sensorPoseParameters, in_dashCoord, vehiclePose_ENU, sensorReading_ENU, perturbation_in_sensorPose, fig_num);
expected_transformed_ENUPoint_in_dashCoord = [9.6027 4.2705 -2.6382];
...
%
% Therefore, the expected answer of the transformed
% sensorReading_ENU in left GPS coordinates will be [-3.3973 -7.7295 -2.6382]
...
transformed_ENUPoint_in_dashCoord = fcn_Transform_ENUToSensorCoord(vehicleParameters, sensorPoseParameters, in_dashCoord, vehiclePose_ENU, sensorReading_ENU, perturbation_in_sensorPose, fig_num);
expected_transformed_ENUPoint_in_dashCoord = [-3.3973 -7.7295 -2.6382];
...
%
% Therefore, the expected answer of the transformed
% sensorReading_ENU in left GPS coordinates will be [9.6027 -3.7295 -8.6382]
...
transformed_ENUPoint_in_dashCoord = fcn_Transform_ENUToSensorCoord(vehicleParameters, sensorPoseParameters, in_dashCoord, vehiclePose_ENU, sensorReading_ENU, perturbation_in_sensorPose, fig_num);
expected_transformed_ENUPoint_in_dashCoord = [9.6027 -3.7295 -8.6382];
...
%
% Therefore, the expected answer of the transformed
% sensorReading_ENU in left GPS coordinates will be [3.6027 -3.7295 -5.6382]
...
transformed_ENUPoint_in_dashCoord = fcn_Transform_ENUToSensorCoord(vehicleParameters, sensorPoseParameters, in_dashCoord, vehiclePose_ENU, sensorReading_ENU, perturbation_in_sensorPose, fig_num);
expected_transformed_ENUPoint_in_dashCoord = [3.6027 -3.7295 -5.6382];
...
% Since we know the offset position of the left GPS from the sensor 
% platform and how it is oriented, the expected answer of the transformed
% sensorReading_ENU in left GPS coordinates will be [6.6027 -4.7295 7.3618]
...
transformed_ENUPoint_in_dashCoord = fcn_Transform_ENUToSensorCoord(vehicleParameters, sensorPoseParameters, in_dashCoord, vehiclePose_ENU, sensorReading_ENU, perturbation_in_sensorPose, fig_num);
expected_transformed_ENUPoint_in_dashCoord = [6.6027 -4.7295 7.3618];
...
%
% Therefore, the expected answer of the transformed
% sensorReading_ENU in left GPS coordinates will be [7.6027 3.2705 -2.6382]
...
transformed_ENUPoint_in_dashCoord = fcn_Transform_ENUToSensorCoord(vehicleParameters, sensorPoseParameters, in_dashCoord, vehiclePose_ENU, sensorReading_ENU, perturbation_in_sensorPose, fig_num);
expected_transformed_ENUPoint_in_dashCoord = [7.6027 3.2705 -2.6382];
...
%
% Therefore, the expected answer of the transformed
% sensorReading_ENU in left GPS coordinates will be [-7.3973 12.2705 1.3618]
...
transformed_ENUPoint_in_dashCoord = fcn_Transform_ENUToSensorCoord(vehicleParameters, sensorPoseParameters, in_dashCoord, vehiclePose_ENU, sensorReading_ENU, perturbation_in_sensorPose, fig_num);
expected_transformed_ENUPoint_in_dashCoord = [-7.3973 12.2705 1.3618];
...
%
% Therefore, the expected answer of the transformed
% sensorReading_ENU in left GPS coordinates will be [6.6027 1.2705 5.3618]
...
transformed_ENUPoint_in_dashCoord = fcn_Transform_ENUToSensorCoord(vehicleParameters, sensorPoseParameters, in_dashCoord, vehiclePose_ENU, sensorReading_ENU, perturbation_in_sensorPose, fig_num);
expected_transformed_ENUPoint_in_dashCoord = [6.6027 1.2705 5.3618];
...
%
% Therefore, the expected answer of the transformed
% sensorReading_ENU in left GPS coordinates will be [19.6027 -6.7295 8.3618]
...
transformed_ENUPoint_in_dashCoord = fcn_Transform_ENUToSensorCoord(vehicleParameters, sensorPoseParameters, in_dashCoord, vehiclePose_ENU, sensorReading_ENU, perturbation_in_sensorPose, fig_num);
expected_transformed_ENUPoint_in_dashCoord = [19.6027 -6.7295 8.3618];
...
%
% Therefore, the expected answer of the transformed
% sensorReading_ENU in left GPS coordinates will be [8.6027 -0.7295 6.3618]
...
%
% Therefore, the expected answer of the transformed
% sensorReading_ENU in left GPS coordinates will be [-11.3973 -5.7295 -11.6382]
...
transformed_ENUPoint_in_dashCoord = fcn_Transform_ENUToSensorCoord(vehicleParameters, sensorPoseParameters, in_dashCoord, vehiclePose_ENU, sensorReading_ENU, perturbation_in_sensorPose, fig_num);
expected_transformed_ENUPoint_in_dashCoord = [-11.3973 -5.7295 -11.6382];
...
%
% Therefore, the expected answer of the transformed
% sensorReading_ENU in left GPS coordinates will be [15.6027 -2.7295 -5.6382]
...
transformed_ENUPoint_in_dashCoord = fcn_Transform_ENUToSensorCoord(vehicleParameters, sensorPoseParameters, in_dashCoord, vehiclePose_ENU, sensorReading_ENU, perturbation_in_sensorPose, fig_num);
expected_transformed_ENUPoint_in_dashCoord = [15.6027 -2.7295 -5.6382];
...
%
% Therefore, the expected answer of the transformed
% sensorReading_ENU in left GPS coordinates will be [7.6027 -5.7295 3.3618]
...
transformed_ENUPoint_in_dashCoord = fcn_Transform_ENUToSensorCoord(vehicleParameters, sensorPoseParameters, in_dashCoord, vehiclePose_ENU, sensorReading_ENU, perturbation_in_sensorPose, fig_num);
expected_transformed_ENUPoint_in_dashCoord = [7.6027 -5.7295 3.3618];
