...
sensorPoseParameters.GPS_Hemisphere_SensorPlatform_Rear.offset_x_relative_to_vehicle = -0.6027;
...
sensorPoseParameters.GPS_SparkFun_RightRear.offset_y_relative_to_sensorplatform =  -0.7295; % Meters - GUESS!!
sensorPoseParameters.GPS_SparkFun_RightRear.offset_z_relative_to_sensorplatform =  0.1121; % Meters - GUESS!!
...
% Lidar Velodyne Rear 
sensorPoseParameters.Lidar_Velodyne_Rear.offset_x_relative_to_sensorplatform = -0.7903; % Meters - GUESS!!
sensorPoseParameters.Lidar_Velodyne_Rear.offset_y_relative_to_sensorplatform =  0.0056; % Meters - GUESS!!
sensorPoseParameters.Lidar_Velodyne_Rear.offset_z_relative_to_sensorplatform = 0.1457; % Meters - GUESS!!
