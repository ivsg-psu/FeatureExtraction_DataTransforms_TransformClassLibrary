function transform_Matrix = fcn_Transform_determineTransformMatrix_Vehicle(vehicleParameters, sensorPoseParameters, sensor_or_vehicle, vehiclePose_ENU, perturbation_in_sensorPose_relative_to_SensorPlatform, varargin)
