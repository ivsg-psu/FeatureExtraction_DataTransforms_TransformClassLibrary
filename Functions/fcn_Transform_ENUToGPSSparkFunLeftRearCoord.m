function transformed_ENUPoint_in_GPSSparkFunLeftRearCoord = fcn_Transform_ENUToGPSSparkFunLeftRearCoord(vehicleParameters, sensorPoseParameters, sensor_or_vehicle, vehiclePose_ENU, sensorReading_ENU, varargin)
...
transformed_ENUPoint_in_GPSSparkFunLeftRearCoord = zeros(size(vehiclePose_ENU,1),3);
...
for i = 1:size(vehiclePose_ENU,1)
    ...
    transformed_ENUPoint_in_GPSSparkFunLeftRearCoord(i,:) = transformed_ENUPoint_in_SensorCoord_homogeneous(1:3,:)';
end
