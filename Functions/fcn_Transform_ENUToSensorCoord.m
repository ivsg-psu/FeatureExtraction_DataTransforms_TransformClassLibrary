function transformed_ENUPoint_in_SensorCoord = fcn_Transform_ENUToSensorCoord(sensorReading_ENU, vehiclePose_ENU, sensor, varargin)
...
% Indirectly, the offset_length, offset_width and offset_height is the
% position of the origin relative to the object (In this case it is the
% mapping van). 
